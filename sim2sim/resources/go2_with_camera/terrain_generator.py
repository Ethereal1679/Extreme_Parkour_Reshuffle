...
ROBOT = "go2"
INPUT_SCENE_PATH = "./depth_camera_scene.xml"
OUTPUT_SCENE_PATH = "./depth_camera_scene_terrain.xml"
...
if __name__ == "__main__":
    ...
    # Stairs
    # tg.AddStairs(init_pos=[2.0, 0.0, 0.0], yaw=0.0, width=0.2, height=0.15, length=15, stair_nums=20)
